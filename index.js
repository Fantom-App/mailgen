...
Mailgen.prototype.cacheThemes = function () {
  ...
  if (typeof this.theme === "object" && this.theme.htmlString) {
    this.cachedTheme = this.theme.htmlString;
  } else {
    var themePath =
  ...
  if (typeof this.theme === "object" && this.theme.plaintextString) {
    this.cachedPlaintextTheme = this.theme.plaintextString;
  } else {
